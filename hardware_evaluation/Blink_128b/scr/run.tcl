...
# Setting environment
# Need modify: Yes
cd /mnt/hgfs/VMShared/TEST/Blink_128_128_2-CodeTestArea
...
set file_path 	[concat /mnt/hgfs/VMShared/TEST/Blink_128_128_2-CodeTestArea]
...
# report each file
#Need modify: Yes
source "${script_path}/Blink_128_128.tcl"
