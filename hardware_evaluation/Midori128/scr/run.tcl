...
# Need modify: Yes
# Setting environment
cd /mnt/hgfs/VMShared/TEST1/Midori_128-CodeTestArea
...
set file_path 	[concat /mnt/hgfs/VMShared/TEST1/Midori_128-CodeTestArea]
...
#Need modify: Yes
# report each file
source "${script_path}/Midori_128.tcl"
